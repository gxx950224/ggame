...
function apply(ctx) {
    ...
    const disposeCss = styles.insert(
      ...
      '.bp-panel{pointer-events:auto;position:fixed;right:0;bottom:76px;z-index:9100;width:min(780px,100vw);height:min(1000px,calc(100vh - 88px));display:flex;flex-direction:column;background:linear-gradient(175deg,#2b2620,#15110d);border:1px solid #3b352c;border-radius:14px;box-shadow:0 14px 48px rgba(0,0,0,.7),inset 0 1px 0 rgba(133,127,103,.08);color:#d6d2c8;font-size:14px;user-select:none;overflow:hidden}' +
